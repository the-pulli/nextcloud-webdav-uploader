...
| `--share-dir`          | Create (or reuse) a public link share for the target folder and print it                      |
| `--share-file`         | Create (or reuse) a public link share for the uploaded file and print it (exactly one file only) |
